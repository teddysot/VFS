...
/*
Create a linked list class called "DoublyLinkedList" that contains templated node instances
...
DoublyLinkedList* Clone(); // clones the current doubly linked list, creating a new independent one
*/
...
{
public:
	Node() :nData(nullptr), mNext(nullptr), mPrev(nullptr)
	{}
